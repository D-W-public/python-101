...
As the whisper faded, a soft glow pulsed through the room, and I felt an unseen presence watching me with ancient, knowing eyes. My heart raced as the warmth wrapped tighter around me, blurring the line between dream and reality until I no longer knew where I truly stood...
...
and I realized it was the ghost of Horatio Von Cluckington III's father, Horatio Von Cluckington II, peering over at me from the windowsill. As I gazed into his pale, blue-white beady eyes amidst the whirlwind of memories, I couldn't help but ask myself...
All the play of the divine mother, the marshmellow, the roasted potato, all and all. """


words = text.split()

# iterate over the text cutting out the word probably by using the space as a marker

new_list = [w[1:] + w[0] + "ay" for w in words if len(w) > 0]
